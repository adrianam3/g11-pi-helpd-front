    ...
    ngOnInit() {
        this.model = [
            ...
            },
            {
                label: 'GESTIÓN',
                items: [
                    { label: 'ÁREA', icon: 'pi pi-fw pi-table', routerLink: ['/area/area-list'] },
                    { label: 'Departamento', icon: 'pi pi-fw pi-list', routerLink: ['/departamento/departamento-list'] },
                    { label: 'Rol', icon: 'pi pi-fw pi-id-card', routerLink: ['/rol/rol-list'] },
                ]
            },
            {
